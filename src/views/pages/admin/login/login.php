              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Insira seu e-mail e sua senha para entrar</p>
                  </div>
                  ...
                  <form action="" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Insira a sua senha!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Não tem uma conta? <a href="<?=$base;?>/admin/cadastro">Criar uma conta</a></p>
                    </div>
                    <?php endif;?>
